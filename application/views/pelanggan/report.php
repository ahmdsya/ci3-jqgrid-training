...
<head>
  ...
  <script type="text/javascript" src="<?= base_url('assets/stimulsoft-report/2021.3.6/scripts/stimulsoft.viewer.js') ?>"></script>
  <script type="text/javascript" src="<?= base_url('assets/stimulsoft-report/2021.3.6/scripts/stimulsoft.dashboards.js') ?>"></script>
  <script type="text/javascript" src="<?= base_url('assets/stimulsoft-report/2021.3.6/scripts/stimulsoft.designer.js') ?>"></script>
  <script src="https://code.jquery.com/jquery-3.6.0.js" integrity="sha256-H+K7U5CnXl1h5ywQfKtSj8PCmoN9aaq30gDh27Xc0jk=" crossorigin="anonymous"></script>
  <script type="text/javascript">
    function Start() {
      Stimulsoft.Base.StiLicense.loadFromFile("../assets/stimulsoft-report/2021.3.6/stimulsoft/license.php");
      ...
      report.loadFile('../assets/report/MasterDetail.mrt')
